package edu.ufp.pam.examples.farrusco
...
import edu.ufp.pam.examples.farrusco.workers.WorkManagerHelper
import edu.ufp.pam.examples.farrusco.workers.WorkManagerHelper.Companion.TAG_WORKER_DOWNLOAD_OUTPUT
...
class MainFarruscoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.e(
            this.javaClass.simpleName, "onCreate(): urlTest = $urlTest"
        )
        ...
        fab_farrusco.setOnClickListener { view ->
       ...
       */
        ...
        buttonUp.setOnClickListener(object : View.OnClickListener {
    ...
    private fun setFarruscoMovementAndLaunch(move: String) {
        ...
        val urlStr = urlInputID.text.toString()
        //Time of movement
        val timeStr = timeID.text.toString()
        //Farrusco ID (2)
    ...
    private fun launchViewModelAsyncHttpRequest(urlStr: String, queryStr: String) {
        Log.e(
            ...
            "launchViewModelAsyncHttpRequest(): url+query=$urlStr$queryStr"
        )
    ...
    private fun launchDownloadWorkerAsyncHttpRequest(urlStr: String, queryStr: String) {
        Log.e(
            this.javaClass.simpleName,
            "launchDownloadWorkerAsyncHttpRequest(): url+query=$urlStr$queryStr"
        )
